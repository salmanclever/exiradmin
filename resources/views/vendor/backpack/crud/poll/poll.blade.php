        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header {{ $crud->hasAccess('create')?'with-border':'' }}">
                    ...
                    @include('crud::inc.button_stack', ['stack' => 'top'])<!-- Modal structure -->
...
@section('after_styles')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/tingle/dist/tingle.css') }}">
...
@section('after_scripts')
    ...
    <script src="{{ asset('vendor/backpack/crud/js/tingle.js') }}"></script>
    <script src="{{ asset('vendor/backpack/crud/js/addel.jquery.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($){
            ...
            modal.setContent(' <img src="{{ asset('vendor/backpack/crud/img/103.gif') }}" alt="">');
