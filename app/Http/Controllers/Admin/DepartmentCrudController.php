...
class DepartmentCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings('دپارتمان', 'دپارتمان ها');
        ...
        */
        ...
        $this->crud->addColumn([
                'name' => 'manager', // The db column name
                'label' => "مدیر", // Table column heading
            ]
        );
        ...
        // Show export to PDF, CSV, XLS and departmentsPrint buttons on the table view.
